...
interface KofuAreaMapProps { userInfo?: any; pickingLocation?: boolean; onLocationPick?: (lat: number, lng: number) => void; journalEntries?: { id: string; record_date: string; text_content: string | null; location: { lat: number; lng: number } | null }[]; onJournalMarkerClick?: (entryId: string) => void; }
export default function KofuAreaMap({ userInfo, pickingLocation, onLocationPick, journalEntries = [], onJournalMarkerClick }: KofuAreaMapProps) {
    // キャッシュ管理フックの初期化
